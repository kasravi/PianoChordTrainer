...
const commonChordNames = ['C major', 'D major', 'E major', 'F major', 'G major', 'A major', 'D minor', 'E minor', 'A minor', 'C dominant seventh', 'D dominant seventh', 'E dominant seventh', 'G dominant seventh', 'A dominant seventh', 'B dominant seventh', 'D minor seventh', 'A minor seventh', 'C major seventh', 'F major seventh', 'A major seventh']


export const allChords = chordsTypes.flatMap(f=>notes.map(note=>{
    ...
    return {
        ...
        notes:notes,
        common:commonChordNames.indexOf(note + " " + f.name)
    }}))
